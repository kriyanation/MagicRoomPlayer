...
class MagicFactualPage(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.labelframeone = ttk.Labelframe(self, width = parent.screen_width/1.7, height = parent.screen_height/1.5, text="Did you know?", relief=tk.RIDGE,style='Red.TLabelframe')
        self.labelframetwo = ttk.Labelframe(self, width = parent.screen_width/1.7, height = parent.screen_height/1.5,text="Did you know?", relief=tk.RIDGE,style='Red.TLabelframe')
        self.labelframethree = ttk.Labelframe(self,width = parent.screen_width/1.7, height = parent.screen_height/1.5, text="Did you know?", relief=tk.RIDGE,style='Red.TLabelframe')
